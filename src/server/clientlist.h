 ...
 *
 * @var LLNode::client_info \c ClientInfo struct containing the actual
 * informations.
 * @var LLNode::next Pointer to the next node of the list.
 */
struct LLNode {
 ...
 *
 * @var LinkedList::head Pointer to the first node of the list.
 * @var LinkedList::tail Pointer to the last node of the list.
 * @var LinkedList::size Number of nodes in the list.
 */
struct LinkedList {
